...
*/
int hammingWeight_1(uint32_t value) {
  int count = 0;
  while (value) {
    value = value & (value - 1);
    count++;
...
int hammingWeight_2(uint32_t value) {
  int count = 0;
  while (value) {
    count = count + (value % 2);
    value = value >> 1;
...
int hammingWeight_3(uint32_t value) {
  int count = 0;
  while (value) {
    count = count + (value & 1);
    value = value >> 1;
...
int main() {
  uint32_t value = 0x0A55;
  cout << "hammingWeight_1:" << hammingWeight_1(value) << endl;
  cout << "hammingWeight_2:" << hammingWeight_2(value) << endl;
  cout << "hammingWeight_3:" << hammingWeight_3(value) << endl;
  cout << "hammingWeight_3:" << hammingWeight_4(value) << endl;
  return 0;
}